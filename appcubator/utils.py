...
## BEGIN RANDOM PRIMARY ##

"""
copy pasted from

http://blog.brendel.com/2012/04/random-primary-keys-for-django-models.html
https://github.com/jbrendel/django-randomprimary/blob/master/random_primary.py
